...
goog.exportSymbol('proto.casper.CloseBlockSystemDeployDataProto', null, global);
...
goog.exportSymbol('proto.casper.ProcessedSystemDeployProto', null, global);
...
goog.exportSymbol('proto.casper.SlashSystemDeployDataProto', null, global);
goog.exportSymbol('proto.casper.SystemDeployDataProto', null, global);
goog.exportSymbol('proto.casper.SystemDeployDataProto.SystemdeployCase', null, global);
 ...
 * @constructor
 */
proto.casper.SlashSystemDeployDataProto = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.casper.SlashSystemDeployDataProto, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.casper.SlashSystemDeployDataProto.displayName = 'proto.casper.SlashSystemDeployDataProto';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.casper.CloseBlockSystemDeployDataProto = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.casper.CloseBlockSystemDeployDataProto, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.casper.CloseBlockSystemDeployDataProto.displayName = 'proto.casper.CloseBlockSystemDeployDataProto';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.casper.SystemDeployDataProto = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.casper.SystemDeployDataProto.oneofGroups_);
};
goog.inherits(proto.casper.SystemDeployDataProto, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.casper.SystemDeployDataProto.displayName = 'proto.casper.SystemDeployDataProto';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.casper.ProcessedSystemDeployProto = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.casper.ProcessedSystemDeployProto.repeatedFields_, null);
};
goog.inherits(proto.casper.ProcessedSystemDeployProto, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.casper.ProcessedSystemDeployProto.displayName = 'proto.casper.ProcessedSystemDeployProto';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.casper.BlockHashMessageProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    hash: msg.getHash_asB64(),
    blockcreator: msg.getBlockcreator_asB64()
  };
...
proto.casper.BlockHashMessageProto.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getBlockcreator_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      2,
      f
 ...
 * @return {string}
 */
proto.casper.BlockHashMessageProto.prototype.getBlockcreator = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
...
/**
 * optional bytes blockCreator = 2;
 * This is a type-conversion wrapper around `getBlockcreator()`
 * @return {string}
 */
proto.casper.BlockHashMessageProto.prototype.getBlockcreator_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getBlockcreator()));
};
 ...
 * @return {!Uint8Array}
 */
proto.casper.BlockHashMessageProto.prototype.getBlockcreator_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getBlockcreator()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.casper.DeployDataProto} returns this
 */
 ...
 * @const
 */
proto.casper.ProcessedDeployProto.repeatedFields_ = [3];
...
proto.casper.ProcessedDeployProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    errored: jspb.Message.getBooleanFieldWithDefault(msg, 5, false),
    systemdeployerror: jspb.Message.getFieldWithDefault(msg, 6, "")
  };
 ...
 * @return {!proto.casper.ProcessedDeployProto} returns this
*/
...
/**
 * optional string systemDeployError = 6;
 * @return {string}
 */
proto.casper.ProcessedDeployProto.prototype.getSystemdeployerror = function() {
 ...
 * @return {!proto.casper.ProcessedDeployProto} returns this
 */
proto.casper.ProcessedDeployProto.prototype.setSystemdeployerror = function(value) {
 ...
 * @return {!Object}
 */
proto.casper.SlashSystemDeployDataProto.prototype.toObject = function(opt_includeInstance) {
  return proto.casper.SlashSystemDeployDataProto.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.casper.SlashSystemDeployDataProto} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.casper.SlashSystemDeployDataProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    invalidblockhash: msg.getInvalidblockhash_asB64(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.casper.SlashSystemDeployDataProto}
 */
proto.casper.SlashSystemDeployDataProto.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.casper.SlashSystemDeployDataProto;
  return proto.casper.SlashSystemDeployDataProto.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.casper.SlashSystemDeployDataProto} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.casper.SlashSystemDeployDataProto}
 */
proto.casper.SlashSystemDeployDataProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.casper.SlashSystemDeployDataProto.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.casper.SlashSystemDeployDataProto.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.casper.SlashSystemDeployDataProto} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.casper.SlashSystemDeployDataProto.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getInvalidblockhash_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      1,
      f
 ...
 * @return {string}
 */
proto.casper.SlashSystemDeployDataProto.prototype.getInvalidblockhash = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * optional bytes invalidBlockHash = 1;
 * This is a type-conversion wrapper around `getInvalidblockhash()`
 * @return {string}
 */
proto.casper.SlashSystemDeployDataProto.prototype.getInvalidblockhash_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getInvalidblockhash()));
};
 ...
 * @return {!Uint8Array}
 */
proto.casper.SlashSystemDeployDataProto.prototype.getInvalidblockhash_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getInvalidblockhash()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.casper.SlashSystemDeployDataProto} returns this
 */
proto.casper.SlashSystemDeployDataProto.prototype.setInvalidblockhash = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.casper.SlashSystemDeployDataProto.prototype.getIssuerpublickey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.casper.SlashSystemDeployDataProto.prototype.getIssuerpublickey_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
 ...
 * @return {!Uint8Array}
 */
proto.casper.SlashSystemDeployDataProto.prototype.getIssuerpublickey_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getIssuerpublickey()));
};
 ...
 * @return {!proto.casper.SlashSystemDeployDataProto} returns this
 */
proto.casper.SlashSystemDeployDataProto.prototype.setIssuerpublickey = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.casper.CloseBlockSystemDeployDataProto.prototype.toObject = function(opt_includeInstance) {
  return proto.casper.CloseBlockSystemDeployDataProto.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.casper.CloseBlockSystemDeployDataProto} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.casper.CloseBlockSystemDeployDataProto.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.casper.CloseBlockSystemDeployDataProto}
 */
proto.casper.CloseBlockSystemDeployDataProto.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.casper.CloseBlockSystemDeployDataProto;
  return proto.casper.CloseBlockSystemDeployDataProto.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.casper.CloseBlockSystemDeployDataProto} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.casper.CloseBlockSystemDeployDataProto}
 */
proto.casper.CloseBlockSystemDeployDataProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.casper.CloseBlockSystemDeployDataProto.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.casper.CloseBlockSystemDeployDataProto.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.casper.CloseBlockSystemDeployDataProto} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.casper.CloseBlockSystemDeployDataProto.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.casper.SystemDeployDataProto.oneofGroups_ = [[1,2]];

/**
 * @enum {number}
 */
proto.casper.SystemDeployDataProto.SystemdeployCase = {
  SYSTEMDEPLOY_NOT_SET: 0,
  SLASHSYSTEMDEPLOY: 1,
  CLOSEBLOCKSYSTEMDEPLOY: 2
};

/**
 * @return {proto.casper.SystemDeployDataProto.SystemdeployCase}
 */
proto.casper.SystemDeployDataProto.prototype.getSystemdeployCase = function() {
  return /** @type {proto.casper.SystemDeployDataProto.SystemdeployCase} */(jspb.Message.computeOneofCase(this, proto.casper.SystemDeployDataProto.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.casper.SystemDeployDataProto.prototype.toObject = function(opt_includeInstance) {
  return proto.casper.SystemDeployDataProto.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.casper.SystemDeployDataProto} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.casper.SystemDeployDataProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    slashsystemdeploy: (f = msg.getSlashsystemdeploy()) && proto.casper.SlashSystemDeployDataProto.toObject(includeInstance, f),
    closeblocksystemdeploy: (f = msg.getCloseblocksystemdeploy()) && proto.casper.CloseBlockSystemDeployDataProto.toObject(includeInstance, f)
  };
 ...
 */
proto.casper.SystemDeployDataProto.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.casper.SystemDeployDataProto;
  return proto.casper.SystemDeployDataProto.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.casper.SystemDeployDataProto} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.casper.SystemDeployDataProto}
 */
proto.casper.SystemDeployDataProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.casper.SlashSystemDeployDataProto;
      reader.readMessage(value,proto.casper.SlashSystemDeployDataProto.deserializeBinaryFromReader);
      msg.setSlashsystemdeploy(value);
      break;
    case 2:
      var value = new proto.casper.CloseBlockSystemDeployDataProto;
      reader.readMessage(value,proto.casper.CloseBlockSystemDeployDataProto.deserializeBinaryFromReader);
      msg.setCloseblocksystemdeploy(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.casper.SystemDeployDataProto.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.casper.SystemDeployDataProto.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.casper.SystemDeployDataProto} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.casper.SystemDeployDataProto.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSlashsystemdeploy();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.casper.SlashSystemDeployDataProto.serializeBinaryToWriter
    );
  }
  f = message.getCloseblocksystemdeploy();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.casper.CloseBlockSystemDeployDataProto.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional SlashSystemDeployDataProto slashSystemDeploy = 1;
 * @return {?proto.casper.SlashSystemDeployDataProto}
 */
proto.casper.SystemDeployDataProto.prototype.getSlashsystemdeploy = function() {
  return /** @type{?proto.casper.SlashSystemDeployDataProto} */ (
    jspb.Message.getWrapperField(this, proto.casper.SlashSystemDeployDataProto, 1));
};


/**
 * @param {?proto.casper.SlashSystemDeployDataProto|undefined} value
 * @return {!proto.casper.SystemDeployDataProto} returns this
*/
proto.casper.SystemDeployDataProto.prototype.setSlashsystemdeploy = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.casper.SystemDeployDataProto.oneofGroups_[0], value);
};
 ...
 * @return {!proto.casper.SystemDeployDataProto} returns this
 */
proto.casper.SystemDeployDataProto.prototype.clearSlashsystemdeploy = function() {
  return this.setSlashsystemdeploy(undefined);
};
 ...
 * @return {boolean}
 */
proto.casper.SystemDeployDataProto.prototype.hasSlashsystemdeploy = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional CloseBlockSystemDeployDataProto closeBlockSystemDeploy = 2;
 * @return {?proto.casper.CloseBlockSystemDeployDataProto}
 */
proto.casper.SystemDeployDataProto.prototype.getCloseblocksystemdeploy = function() {
  return /** @type{?proto.casper.CloseBlockSystemDeployDataProto} */ (
    jspb.Message.getWrapperField(this, proto.casper.CloseBlockSystemDeployDataProto, 2));
};


/**
 * @param {?proto.casper.CloseBlockSystemDeployDataProto|undefined} value
 * @return {!proto.casper.SystemDeployDataProto} returns this
*/
proto.casper.SystemDeployDataProto.prototype.setCloseblocksystemdeploy = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.casper.SystemDeployDataProto.oneofGroups_[0], value);
};
 ...
 * @return {!proto.casper.SystemDeployDataProto} returns this
 */
proto.casper.SystemDeployDataProto.prototype.clearCloseblocksystemdeploy = function() {
  return this.setCloseblocksystemdeploy(undefined);
};
 ...
 * @return {boolean}
 */
proto.casper.SystemDeployDataProto.prototype.hasCloseblocksystemdeploy = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @const
 */
proto.casper.ProcessedSystemDeployProto.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.casper.ProcessedSystemDeployProto.prototype.toObject = function(opt_includeInstance) {
  return proto.casper.ProcessedSystemDeployProto.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.casper.ProcessedSystemDeployProto} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.casper.ProcessedSystemDeployProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    systemdeploy: (f = msg.getSystemdeploy()) && proto.casper.SystemDeployDataProto.toObject(includeInstance, f),
    deploylogList: jspb.Message.toObjectList(msg.getDeploylogList(),
    proto.casper.EventProto.toObject, includeInstance),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.casper.ProcessedSystemDeployProto}
 */
proto.casper.ProcessedSystemDeployProto.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.casper.ProcessedSystemDeployProto;
  return proto.casper.ProcessedSystemDeployProto.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.casper.ProcessedSystemDeployProto} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.casper.ProcessedSystemDeployProto}
 */
proto.casper.ProcessedSystemDeployProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.casper.SystemDeployDataProto;
      reader.readMessage(value,proto.casper.SystemDeployDataProto.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.casper.ProcessedSystemDeployProto.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.casper.ProcessedSystemDeployProto.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.casper.ProcessedSystemDeployProto} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.casper.ProcessedSystemDeployProto.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.casper.SystemDeployDataProto.serializeBinaryToWriter
    );
  }
  f = message.getDeploylogList();
  if (f.length > 0) {
 ...
 * @return {?proto.casper.SystemDeployDataProto}
 */
proto.casper.ProcessedSystemDeployProto.prototype.getSystemdeploy = function() {
  return /** @type{?proto.casper.SystemDeployDataProto} */ (
    jspb.Message.getWrapperField(this, proto.casper.SystemDeployDataProto, 1));
};


/**
 * @param {?proto.casper.SystemDeployDataProto|undefined} value
 * @return {!proto.casper.ProcessedSystemDeployProto} returns this
*/
proto.casper.ProcessedSystemDeployProto.prototype.setSystemdeploy = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.casper.ProcessedSystemDeployProto} returns this
 */
proto.casper.ProcessedSystemDeployProto.prototype.clearSystemdeploy = function() {
 ...
 * @return {boolean}
 */
proto.casper.ProcessedSystemDeployProto.prototype.hasSystemdeploy = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Array<!proto.casper.EventProto>}
 */
proto.casper.ProcessedSystemDeployProto.prototype.getDeploylogList = function() {
  return /** @type{!Array<!proto.casper.EventProto>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.casper.EventProto, 2));
};
 ...
 * @return {!proto.casper.ProcessedSystemDeployProto} returns this
*/
proto.casper.ProcessedSystemDeployProto.prototype.setDeploylogList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.casper.EventProto}
 */
proto.casper.ProcessedSystemDeployProto.prototype.addDeploylog = function(opt_value, opt_index) {
 ...
 * @return {!proto.casper.ProcessedSystemDeployProto} returns this
 */
proto.casper.ProcessedSystemDeployProto.prototype.clearDeploylogList = function() {
  return this.setDeploylogList([]);
};
 ...
 * @return {string}
 */
proto.casper.ProcessedSystemDeployProto.prototype.getErrormsg = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.casper.ProcessedSystemDeployProto} returns this
 */
proto.casper.ProcessedSystemDeployProto.prototype.setErrormsg = function(value) {
 ...
 * @const
 */
proto.casper.BodyProto.repeatedFields_ = [2,3];
...
proto.casper.BodyProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.casper.ProcessedSystemDeployProto.toObject, includeInstance),
    extrabytes: msg.getExtrabytes_asB64()
  };
...
proto.casper.BodyProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.casper.ProcessedSystemDeployProto;
      reader.readMessage(value,proto.casper.ProcessedSystemDeployProto.deserializeBinaryFromReader);
...
proto.casper.BodyProto.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.casper.ProcessedSystemDeployProto.serializeBinaryToWriter
    );
  }
  f = message.getExtrabytes_asU8();
  if (f.length > 0) {
 ...
 * @return {!Array<!proto.casper.ProcessedSystemDeployProto>}
 */
proto.casper.BodyProto.prototype.getSystemdeploysList = function() {
  return /** @type{!Array<!proto.casper.ProcessedSystemDeployProto>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.casper.ProcessedSystemDeployProto, 3));
};


/**
 * @param {!Array<!proto.casper.ProcessedSystemDeployProto>} value
 * @return {!proto.casper.BodyProto} returns this
*/
proto.casper.BodyProto.prototype.setSystemdeploysList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};


/**
 * @param {!proto.casper.ProcessedSystemDeployProto=} opt_value
 * @param {number=} opt_index
 * @return {!proto.casper.ProcessedSystemDeployProto}
 */
proto.casper.BodyProto.prototype.addSystemdeploys = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.casper.ProcessedSystemDeployProto, opt_index);
};
 ...
 * @return {!proto.casper.BodyProto} returns this
 */
proto.casper.BodyProto.prototype.clearSystemdeploysList = function() {
