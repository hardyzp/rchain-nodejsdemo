/**
 * Generated TypeScript definitions for RNode v0.9.24
 */
declare module "@tgrospic/rnode-grpc-js" {
  ...
  interface DeployService {
    ...
    getEventByHash(_?: BlockQuery): Promise<EventInfoResponse>
  }
  ...
  interface ReportCommProto {
    ...
    producesList?: ReportProduceProto[]
  }
  ...
  interface SingleReport {
    eventsList?: ReportProto[]
  }

  interface DeployInfoWithEventData {
    deployinfo: DeployInfo
    reportList?: SingleReport[]
  }

  interface BlockEventInfo {
    blockinfo: LightBlockInfo
    deploysList?: DeployInfoWithEventData[]
  }

  interface EventInfoResponse {
    result?: BlockEventInfo
  }
  ...
  interface TypesBinary {
    ...
    ReportProduceProto: BinaryOp<ReportProduceProto>
    ReportConsumeProto: BinaryOp<ReportConsumeProto>
    ReportCommProto: BinaryOp<ReportCommProto>
    ReportProto: BinaryOp<ReportProto>
    SingleReport: BinaryOp<SingleReport>
    DeployInfoWithEventData: BinaryOp<DeployInfoWithEventData>
    BlockEventInfo: BinaryOp<BlockEventInfo>
    EventInfoResponse: BinaryOp<EventInfoResponse>
